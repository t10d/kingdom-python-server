...
#             READ, Permission.UPDATE, Permission.DELETE),
...
#             READ, Permission.CREATE, Permission.DELETE),
...
#             READ,),
#             READ, Permission.CREATE),
#             READ, Permission.CREATE, Permission.UPDATE),
...
#             CREATE, Permission.DELETE, Permission.UPDATE),
#         ]
#         for perm in input:
...
#         ]
#         for perm in input:
#             assert is_allowed(READ,), perm) is False
